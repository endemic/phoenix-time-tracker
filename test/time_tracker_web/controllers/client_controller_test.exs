defmodule TimeTrackerWeb.ClientControllerTest do
  use TimeTrackerWeb.ConnCase

  import TimeTracker.AccountsFixtures

  @create_attrs %{address: "some address", city: "some city", email: "some email", name: "some name", state: "some state", zip: "some zip"}
